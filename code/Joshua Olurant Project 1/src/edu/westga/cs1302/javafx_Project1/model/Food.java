...
/**
 * Represents a food item with a name, type, and quantity.
 * The quantity of the food item can be modified, but the name and type are immutable.
 * 
...
public class Food {
    ...
    /**
     * Creates a new Food object with the specified name and type.
    ...
    /**
     * Decrements the quantity of the food item by 1, if the quantity is greater than 0.
     */
